//! Translate a USB HID keyboard **usage ID** (what `flashctrl-core::hid::KeyCode`
...
pub fn usage_to_code(usage: u8) -> Option<&'static str> {
    Some(match usage {
        ...
        0x2B => "Tab", 0x2C => "Space",
        // Punctuation
        0x2D => "Minus", 0x2E => "Equal", 0x2F => "BracketLeft",
        0x30 => "BracketRight", 0x31 => "Backslash", 0x33 => "Semicolon",
        0x34 => "Quote", 0x35 => "Backquote", 0x36 => "Comma",
        ...
        0x4F => "ArrowRight", 0x50 => "ArrowLeft",
        0x51 => "ArrowDown", 0x52 => "ArrowUp",
        // Modifiers (usage 0xE0..=0xE7)
        0xE0 => "ControlLeft", 0xE1 => "ShiftLeft", 0xE2 => "AltLeft",
        0xE3 => "MetaLeft", 0xE4 => "ControlRight", 0xE5 => "ShiftRight",
        0xE6 => "AltRight", 0xE7 => "MetaRight",
        _ => return None,
    })
}
