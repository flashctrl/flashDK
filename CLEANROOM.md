# flashDK: Clean-Room Charter and Rules of Engagement
...
- Runtime dependencies: permissive licenses only (allowlist enforced in CI; see
  `deny.toml` and [docs/credits.md](docs/credits.md)).
- WebRTC: use a permissively-licensed stack, never a GPL one. The project settled on
  `str0m` (MIT) over `webrtc-rs`; see [docs/decisions.md](docs/decisions.md).
